...
**E** = (k * Q / r^2) * **r** (f)
 ...
 ## Representation
 `ElectricField` class provides all necessary functionality for the charged objects handling and the field visualization. It provides 2 modes for field visualization:
 ...
 - Very weak electrifc field is reprented by Blue color
 
 It has a method - `add(_ charge: ChargedNode)` - which adds a charged geometrical object to `ElectricField`.
*/
...
/*:
 ...
 It also allows you easily add new charged geometry to the scene:
 - Point
 - Rod
 - Plate
 
 - Important:
 By long-pressing the object you can move it within a scene and observe how its position changes electric field.
